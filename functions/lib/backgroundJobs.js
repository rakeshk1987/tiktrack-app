 ...
 */
exports.generateDailyTasksJob = functions
    .pubsub
    ...
    try {
        ...
        for (const childDoc of childrenSnapshot.docs) {
            ...
            try {
                ...
                const routine = routineDoc.docs[0].data();
                ...
                const currentMood = moodSnapshot.empty ? undefined : moodSnapshot.docs[0].data();
                ...
                const generatedTasks = (0, taskScheduler_1.generateSmartDailyTasks)(routineSlots, profile, exams, events, currentMood === null || currentMood === void 0 ? void 0 : currentMood.mood, weeklyCompletionRate);
                ...
                for (const task of generatedTasks) {
                    ...
                    if (existingQuery.empty) {
                        await tasksRef.add(Object.assign(Object.assign({}, task), { child_id: childId, is_generated: true, created_at: admin.firestore.FieldValue.serverTimestamp() }));
                        savedCount++;
                    }
                }
 ...
 */
exports.dispatchRemindersJob = functions
    .pubsub
 ...
 */
exports.generateExamPrepTasksJob = functions
    .pubsub
    ...
    try {
        ...
        for (const examDoc of examsSnapshot.docs) {
            ...
            try {
                ...
                const examTasks = (0, taskScheduler_1.generateExamPrepTasks)(exam, daysUntil, profile);
                ...
                for (const task of examTasks) {
                    const existingQuery = await tasksRef
                        ...
                        .get();
                    if (existingQuery.empty) {
                        await tasksRef.add(Object.assign(Object.assign({}, task), { child_id: exam.child_id, is_generated: true, created_at: admin.firestore.FieldValue.serverTimestamp() }));
                        savedCount++;
                    }
                }
 ...
 */
exports.processExpiredMandatoryTasksJob = functions
    .pubsub
            ...
            try {
                ...
                if (missedAction.reduce_stars && penalty > 0) {
                    ...
                    await db.runTransaction(async (transaction) => {
                        ...
                        const currentStars = Number(((_a = profileSnap.data()) === null || _a === void 0 ? void 0 : _a.total_stars) || 0);
 ...
 */
exports.cleanupExpiredDataJob = functions
    .pubsub
...
exports.triggerMandatoryTaskExpiryJob = functions.https.onRequest(async (req, res) => {
    try {
        const result = await exports.processExpiredMandatoryTasksJob.run({}, {});
        res.json({ success: true, result });
    }
    catch (error) {
        res.status(500).json({ success: false, error: error instanceof Error ? error.message : 'Unknown error' });
